...
public class CrossQuizActivity extends AppCompatActivity {
    KoreanWord word;
    Record record;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("십자말 문제");
        setContentView(R.layout.activity_cross_quiz);
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (answer.equals(word.getWord())){
                    ...
                    Animation move = AnimationUtils.loadAnimation(CrossQuizActivity.this, R.anim.move);
                    findViewById(R.id.layout_cross_quiz_info).startAnimation(move);
                }
                else{
                    postRecord(false);
                    Animation shake = AnimationUtils.loadAnimation(CrossQuizActivity.this, R.anim.shake);
